...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2021 at 10:27 AM
...
INSERT INTO `binhluan` (`id`, `id_sanpham`, `id_khachhang`, `name`, `ngay`, `noidung`, `parent_id`) VALUES
(5, 2, 1, 'khang', '2021-09-28 04:55:22', 'hang re, tot', 0),
(7, 2, 1, 'khang', '2021-09-28 05:09:46', 'tot,dep', 0),
(8, 2, 2, 'quoc', '2021-09-28 05:19:44', 'uk,dung roi', 5),
(9, 2, 2, 'quoc', '2021-09-28 05:34:26', 'chuan', 7),
(10, 2, 7, 'thi', '2021-09-28 05:46:24', 'okok', 5),
(11, 2, 7, 'thi', '2021-09-28 05:53:17', 'good job', 5);
...
CREATE TABLE `cthoadon` (
  ...
  `cthoadon_tongtien` int(11) NOT NULL
...
--
-- Table structure for table `hinh_chitiet`
--
...
--
-- Dumping data for table `hinh_chitiet`
--
...
--
-- Indexes for table `hinh_chitiet`
--
...
--
-- AUTO_INCREMENT for table `hinh_chitiet`
--
ALTER TABLE `hinh_chitiet`
...
--
-- Constraints for table `hinh_chitiet`
--
ALTER TABLE `hinh_chitiet`
